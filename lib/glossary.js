...
export const GLOSSARY = [
  ...
  // ----- keyword-gap terms (added 2026-06-09): toothache, miswak, water flosser -----
  {
    slug: 'alam-al-asnan-mustalah',
    term: 'ألم الأسنان',
    termEn: 'Toothache',
    pillar: 'tasawwus-al-asnan',
    synonyms: ['وجع الأسنان', 'مسكّن ألم الأسنان'],
    definition:
  ...
  },
  {
    ...
    pillar: 'al-inaya-al-yawmiyya',
    synonyms: ['النافث المائي', 'مضخّة الماء'],
    definition:
