...
export const LINK_MAP = [
  ...
  // ===== keyword-gap articles (added 2026-06-09) =====
  { term: 'ألم الأسنان', slug: 'alam-al-asnan-al-asbab-wa-mata-yakun-tariyan' },
  { term: 'المسواك', slug: 'al-miswak-wa-sihhat-al-asnan' },
  // competitor-gap articles (added 2026-06-10): x-rays, gum depigmentation, snoring, jaw surgery
  { term: 'أشعة الأسنان', slug: 'ashiat-al-asnan-ma-hiya-wa-hal-aamina' },
  { term: 'توريد اللثة', slug: 'tawrid-al-litha-ma-huwa-wa-hal-aamin' },
  { term: 'جراحة الفم والفكين', slug: 'jirahat-al-fam-wal-fakkayn-ma-hiya-wa-mata' },
  { term: 'الشخير', slug: 'al-shakhir-wa-dawr-tabib-al-asnan' },
  // nutrition pillar (added 2026-06-10)
  { term: 'أطعمة مفيدة للأسنان', slug: 'atima-mufida-li-sihhat-al-asnan-wal-litha' },
  { term: 'التغذية وصحة الفم', slug: 'atima-mufida-li-sihhat-al-asnan-wal-litha' },
  { term: 'الكالسيوم', slug: 'al-kalsiyum-wa-fitamin-d-li-sihhat-al-asnan' },
  { term: 'فيتامين D', slug: 'al-kalsiyum-wa-fitamin-d-li-sihhat-al-asnan' },
  { term: 'السكر والتسوس', slug: 'al-sukkar-wal-tasawwus-al-alaqa-al-haqiqiyya' },
  { term: 'تغذية الأطفال', slug: 'taghdiyat-al-atfal-li-asnan-sihhiyya' },
  // ===== Insight wiring batch (added 2026-06-10): connect existing insights as link targets =====
  { term: 'صحة اللثة والقلب', slug: 'sihat-al-litha-wa-al-qalb-alaqa', type: 'insight' },
  { term: 'صحة اللثة والدماغ', slug: 'sihat-al-litha-wa-al-dimagh', type: 'insight' },
  { term: 'صحة الفم والجهاز الهضمي', slug: 'sihat-al-fam-wal-amad-al-hadmi', type: 'insight' },
  { term: 'صحة الفم والحمل', slug: 'sihat-al-fam-wal-haml-haqaiq', type: 'insight' },
  { term: 'السكري وأمراض اللثة', slug: 'al-sukkari-wa-amrad-al-litha-alaqa-mutabadala', type: 'insight' },
  { term: 'أوزمبيك', slug: 'asnan-ozempic-glp1', type: 'insight' },
  { term: 'أدوية إنقاص الوزن', slug: 'asnan-ozempic-glp1', type: 'insight' },
  { term: 'تجديد الأسنان', slug: 'tajdid-al-asnan-abhath', type: 'insight' },
  { term: 'إنبات أسنان جديدة', slug: 'tajdid-al-asnan-abhath', type: 'insight' },
  { term: 'هلام إعادة بناء المينا', slug: 'hilam-iadat-bina-al-mina', type: 'insight' },
  { term: 'المعجون الأرجواني', slug: 'al-majun-al-arjuwani-v34-hal-yubayyid', type: 'insight' },
  { term: 'أقراص المعجون', slug: 'al-aqras-wal-muntajat-al-tabiiyya-nazra-fahisa', type: 'insight' },
  { term: 'تبييض الحشوات', slug: 'hal-yumkin-tabyid-al-hashwat-wal-tijan', type: 'insight' },
  { term: 'الحمل والمراهقون', slug: 'al-tabyid-wal-haml-wal-murahiqun', type: 'insight' },
  // ===== Gap-fill articles (added 2026-06-10): FAQ-driven genuine gaps =====
  { term: 'شطف الفم بعد التفريش', slug: 'hal-yajib-shatf-al-fam-baad-tanzif-al-asnan' },
  { term: 'الخيط قبل الفرشاة', slug: 'al-khayt-qabl-al-furshat-am-baadaha' },
  { term: 'الحشو الأبيض', slug: 'al-farq-bayna-al-hashw-al-abyad-wal-madini' },
  { term: 'معجون الأسنان الحسّاسة', slug: 'al-majun-al-munasib-lil-asnan-al-hassasa' },
  { term: 'رائحة الفم والمعدة', slug: 'hal-rayihat-al-fam-dalil-mushkila-fil-maada' },
  // ===== Gap-fill articles batch 2 (added 2026-06-10): more FAQ-driven gaps =====
  { term: 'المشروبات الغازية الخالية من السكّر', slug: 'hal-al-mashrubat-al-ghaziyya-al-khaliya-min-al-sukkar-tadurr' },
  { term: 'التنفّس من الفم ورائحة الفم', slug: 'hal-al-tanaffus-min-al-fam-yusabbib-rayihat-al-fam' },
  { term: 'التفريش بعد الحمضيات', slug: 'limadha-la-ufarrish-baad-mashrub-hamidi' },
  { term: 'الشطف بدل التفريش', slug: 'hal-yakfi-shatf-al-fam-badal-al-tanzif' },
  { term: 'الغسول بالكحول', slug: 'al-farq-bayna-ghasul-al-fam-bil-kuhul-wa-bidunih' },
  { term: 'سكر الفواكه', slug: 'hal-sukkar-al-fawakih-yusabbib-al-tasawwus' },
  // ===== Gap-fill articles batch 3 (added 2026-06-10) =====
  { term: 'صرير الأسنان والحساسية', slug: 'hal-sarir-al-asnan-yusabbib-hassasiyya-aw-alaman' },
  { term: 'تسوّس الأطفال والكبار', slug: 'ma-al-farq-bayna-tasawwus-al-atfal-wal-kibar' },
  { term: 'المشروبات الساخنة', slug: 'hal-al-mashrubat-al-sakhina-tadurr-bil-asnan' },
  { term: 'بيكربونات الصوديوم', slug: 'hal-bikarbonat-al-sudyum-amina-li-tanzif-al-asnan' },
  { term: 'الأطعمة اللزجة', slug: 'hal-al-atima-al-laziqa-aswa-ala-al-asnan' },
  { term: 'زوال ألم الأسنان', slug: 'hal-yazul-alam-al-asnan-min-tilqa-nafsih' },
  { term: 'التفريش بقوّة', slug: 'hal-al-tafrish-bi-quwwa-yanzif-afdal' },
  { term: 'مضغ الثلج', slug: 'hal-madgh-al-thalj-yadurr-bil-asnan' },
  // ===== GCC-specific cluster (added 2026-06-10): defensible local content =====
  { term: 'القهوة العربية', slug: 'al-qahwa-al-arabiyya-wal-shay-wa-athruhuma-ala-al-asnan' },
  { term: 'فلورايد مياه الشرب', slug: 'fluorayd-miyah-al-shurb-fi-dual-al-khalij' },
  { term: 'جفاف الفم في الحرّ', slug: 'al-harr-wal-jafaf-fi-al-khalij-wa-jafaf-al-fam' },
  { term: 'الشيشة', slug: 'al-shisha-wal-muassal-wa-sihhat-al-fam-fi-al-khalij' },
  { term: 'المعسّل', slug: 'al-shisha-wal-muassal-wa-sihhat-al-fam-fi-al-khalij' },
  { term: 'المشروبات السكرية', slug: 'al-mashrubat-al-sukkariyya-fi-al-khalij-wa-tasawwus-al-asnan' },
  // ===== GCC cluster batch 2 (added 2026-06-10) =====
  { term: 'التمر وصحة الأسنان', slug: 'al-tamr-wa-sihhat-al-asnan' },
  { term: 'العلاجات الشعبية', slug: 'al-qurunful-wal-ilajat-al-shabiyya-li-alam-al-asnan' },
  { term: 'القرنفل', slug: 'al-qurunful-wal-ilajat-al-shabiyya-li-alam-al-asnan' },
  { term: 'تأمين الأسنان', slug: 'al-tamin-al-sihhi-wa-ilaj-al-asnan-fi-al-khalij' },
  { term: 'الحلويات الخليجية', slug: 'al-halawiyyat-al-khalijiyya-al-taqlidiyya-wa-sihhat-al-asnan' },
];
