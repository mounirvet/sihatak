...
// alternateName (synonyms), pronunciation, image+imageAlt (optional diagram),
// relatedArticles, relatedTerms.
...
export const GLOSSARY = [
  ...
  },
  {
    ...
    image: '/images/glossary/tooth-decay-stages.svg',
    imageAlt: 'رسم توضيحي يُظهر مراحل تسوّس السن: سليم ثم بقعة سطحية ثم تجويف أكبر',
  ...
  },
  {
    ...
    image: '/images/glossary/tooth-cross-section.svg',
    imageAlt: 'رسم توضيحي مبسّط لمقطع عرضي في السن يُظهر طبقاته: المينا الخارجية الصلبة، فالعاج، فاللبّ الداخلي مع قناة الجذر',
  ...
  },
  {
    ...
    image: '/images/glossary/gum-recession.svg',
    imageAlt: 'رسم توضيحي يقارن بين لثة سليمة تغطّي جذر السن ولثة منحسرة تكشف جزءاً من الجذر',
  ...
  },
  {
    ...
    image: '/images/glossary/dental-implant.svg',
    imageAlt: 'رسم توضيحي مبسّط لبنية زرعة الأسنان: الغرسة في عظم الفكّ والدعامة والتاج',
  ...
  },
  {
    ...
    image: '/images/glossary/malocclusion.svg',
    imageAlt: 'رسم توضيحي يقارن بين إطباق أسنان منتظم وإطباق غير منتظم',
  ...
  },
  {
    ...
    image: '/images/glossary/periodontal-pocket.svg',
    imageAlt: 'رسم توضيحي مبسّط لجيب لثوي: ابتعاد اللثة عن السن مكوّنةً فراغاً مقارنةً بلثة سليمة',
