...
export default async function OGImage({ params }) {
    ...
    return new ImageResponse(
      (
        <div style={{ width: '100%', height: '100%', display: 'flex', position: 'relative', fontFamily: 'Tajawal' }}>
          ...
          <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'flex-end', padding: '70px 80px' }}>
            {pillarTitle && (
              <div style={{ fontSize: 32, color: '#0B2027', background: '#D9EBE9', padding: '10px 28px', borderRadius: 999, marginBottom: 24 }}>{pillarTitle}</div>
            )}
            <div style={{ fontSize: 64, fontWeight: 700, color: '#FFFFFF', lineHeight: 1.4, maxWidth: 1040, direction: 'rtl', textAlign: 'right', textAlignLast: 'right', marginBottom: 28 }}>{title}</div>
  ...
  return new ImageResponse(
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'flex-end', background: '#FBF9F4', padding: '70px 80px', fontFamily: 'Tajawal' }}>
        ...
        <div style={{ fontSize: 68, fontWeight: 700, color: '#0B2027', lineHeight: 1.4, maxWidth: 1040, direction: 'rtl', textAlign: 'right', textAlignLast: 'right' }}>{title}</div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', direction: 'rtl', width: '100%' }}>
