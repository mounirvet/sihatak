...
const LINK_MAP = [
  ...
  // ===== Tooth replacement cluster (added 2026-06-09) — ziraat-al-asnan =====
  // longest/most-specific terms first; slugs are bare (code prepends /maqalat/)
  { term: 'تعويض الأسنان لكبار السن', slug: 'taawid-al-asnan-li-kibar-al-sinn' },
  { term: 'تعويض الأسنان مع أمراض اللثة', slug: 'taawid-al-asnan-maa-amrad-al-litha' },
  { term: 'التعافي بعد تعويض الأسنان', slug: 'al-awda-lil-hayat-baad-taawid-al-asnan' },
  { term: 'مضاعفات تعويض الأسنان', slug: 'mudaafat-taawid-al-asnan' },
  { term: 'تعويض الأسنان الأمامية', slug: 'taawid-al-asnan-al-amamiyya-wal-khalfiyya' },
  { term: 'تعويض الأسنان الخلفية', slug: 'taawid-al-asnan-al-amamiyya-wal-khalfiyya' },
  { term: 'تعويض الأسنان والتغذية', slug: 'taawid-al-asnan-wal-taghdiya' },
  { term: 'تعويض الأسنان والكلام', slug: 'taawid-al-asnan-wal-nutq' },
  { term: 'الأطعمة وتعويض الأسنان', slug: 'atima-tahmi-aw-tadurr-taawid-al-asnan' },
  { term: 'تعويض الضرس المخلوع', slug: 'taawid-al-dirs-al-makhlou' },
  { term: 'تعويض الأسنان بعد حادث', slug: 'taawid-al-asnan-baad-hadith-aw-kasr' },
  { term: 'خطوات تعويض الأسنان', slug: 'khutuwat-taawid-al-asnan' },
  { term: 'العناية بالأسنان المعوضة', slug: 'al-inaya-bil-asnan-al-muawwada' },
  { term: 'كم يدوم تعويض الأسنان', slug: 'kam-yadum-taawid-al-asnan' },
  { term: 'تكلفة تعويض الأسنان', slug: 'taklifat-taawid-al-asnan-muqarana' },
  { term: 'فقدان العظم بعد الخلع', slug: 'fuqdan-al-azm-baad-al-khala' },
  { term: 'ذوبان عظم الفك', slug: 'fuqdan-al-azm-baad-al-khala' },
  { term: 'أخطاء اختيار التعويض', slug: 'akhta-shaia-fi-ikhtiyar-taawid-al-asnan' },
  { term: 'تعويض سن واحد', slug: 'taawid-sin-wahid-aw-iddat-asnan' },
  { term: 'تعويض عدة أسنان', slug: 'taawid-sin-wahid-aw-iddat-asnan' },
  { term: 'التعويض المؤقت', slug: 'al-taawid-al-muaqqat' },
  { term: 'خرافات تعويض الأسنان', slug: 'khurafat-shaia-hawl-taawid-al-asnan' },
  { term: 'اتزان العضة', slug: 'taawid-al-asnan-wa-mafsil-al-fakk' },
  { term: 'مفصل الفك', slug: 'taawid-al-asnan-wa-mafsil-al-fakk' },
];
